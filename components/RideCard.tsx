  ...
  <View className="flex flex-row justify-center items-center bg-white rounded-lg shadow-sm shadow-neutral-300 mb-3">
    <View className="flex flex-col justify-center items-center p-3">
      <View className="flex flex-row justify-between items-center">
        <Image
          source={{
            uri: `https://maps.geoapify.com/v1/staticmap?style=osm-bright&width=600&height=400&center=lonlat:${destination_longitude},${destination_latitude}&zoom=14&api_key=${process.env.EXPO_PUBLIC_GEOAPIFY_API_KEY}`,
          }}
      ...
      <View className="flex flex-col justify-center items-start w-full mt-5 bg-general-500 rounded-lg p-3">
